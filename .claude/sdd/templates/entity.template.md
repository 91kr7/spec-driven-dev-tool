<!--
  ...
  Copy to .sdd/specs/<MOD>/model/<ENT-id>.spec.md. An entity describes WHAT data it holds + the rules that bind it,
...
# Fields
<Neutral types (scot.md §2). Constraints are declarative facts (required/unique/format/range/default/derived), not storage directives.>
