<!--
  ...
  Copy to .sdd/specs/<MOD>/features/<FEAT-nnn>.spec.md. Authority: conventions [§2](../conventions.md#2-identifier-scheme)/[§3](../conventions.md#3-spec-front-matter)/[§5](../conventions.md#5-status-lifecycle-and-separation-of-duties); body = SCoT (scot.md,
