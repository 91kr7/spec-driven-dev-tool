...
## Outputs
- One spec per planned entity in the right folder (§1), `status: draft`, + the mandatory `specs/modules/MOD-build.spec.md` (and `specs/modules/MOD-schema.spec.md` for a DB project).
